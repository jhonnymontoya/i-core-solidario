			...
			<div class="card card-{{ $errors->count()?'danger':'success' }} card-outline">
				...
				<div class="card-body">
					...
					<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" href="{{ route('modalidadCreditoEdit', $modalidad) }}">Plazo</a>
						</li>
						<li class="nav-item">
						...
						<div class="tab-pane fade show active">
							...
							<div class="row">
								<div class="col-md-12 text-center">
									<div class="form-group">
										<label class="control-label">¿Plazo condicionado?</label>
										<div>
											@php
												$valid = $errors->has('plazo_condicionado') ? 'is-invalid' : '';
												$plazoCondicionado = empty(old('plazo_condicionado')) ? $modalidad->es_plazo_condicionado : old('plazo_condicionado');
											@endphp
											<div class="btn-group btn-group-toggle" data-toggle="buttons">
												<label class="btn btn-primary {{ $plazoCondicionado ? 'active' : '' }}">
													{!! Form::radio('plazo_condicionado', 1, ($plazoCondicionado ? true : false), ['class' => [$valid]]) !!}Sí
												</label>
												<label class="btn btn-primary {{ !$plazoCondicionado ? 'active' : '' }}">
													{!! Form::radio('plazo_condicionado', 0, (!$plazoCondicionado ? true : false ), ['class' => [$valid]]) !!}No
												</label>
											</div>
											@if ($errors->has('plazo_condicionado'))
												<div class="invalid-feedback">{{ $errors->first('plazo_condicionado') }}</div>
											@endif
										</div>
									</div>
								</div>
							...
							<div class="row form-horizontal" id="sinPlazoCondicionado">
								<div class="col-md-12">
									<div class="form-group">
										...
										@endphp
										<label class="control-label">Plazo máximo en meses</label>
										{!! Form::number('plazo', null, ['class' => [$valid, 'form-control'], 'autocomplete' => 'off', 'placeholder' => 'Plazo']) !!}
										@if ($errors->has('plazo'))
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										{!! Form::select('condicionPor', ['ANTIGUEDADENTIDAD' => 'Antigüedad entidad', 'ANTIGUEDADEMPRESA' => 'Antigüedad empresa', 'MONTO' => 'Monto'], ($modalidad->es_plazo_condicionado ? $modalidad->condicionesModalidad->where('tipo_condicion', 'PLAZO')->first()->condicionado_por : null), ['class' => [$valid, 'form-control', 'select2'], 'placeholder' => 'Seleccione una opción']) !!}
