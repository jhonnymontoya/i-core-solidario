...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-2">
				<a href="{{ url('modalidadCredito/create') }}" class="btn btn-primary">Crear nueva</a>
			</div>
		</div>
		<br>
		<div class="container-fluid">
				...
				<div class="card-body">
					...
					@if(!$modalidades->total())
						<p>
							<div class="row">
								<div class="col-md-12">
									No se encontraron modalidades de créditos <a href="{{ url('modalidadCredito/create') }}" class="btn btn-primary btn-sm">crear una nueva</a>
								</div>
							</div>
						</p>
					@else
								...
								<tbody>
									@foreach ($modalidades as $modalidad)
										<tr>
											...
											<td><a class="btn btn-info btn-sm" href="{{ route('modalidadCreditoEdit', $modalidad) }}"><i class="fa fa-edit"></i></a></td>
										</tr>
									@endforeach
								</tbody>
							</table>
