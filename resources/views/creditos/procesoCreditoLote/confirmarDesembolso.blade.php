...
<div class="content-wrapper">
	...
	<section class="content">
		...
		@endif
		{!! Form::model($proceso, ['route' => ['procesoCreditoLotePutDesembolsar', $proceso], 'method' => 'put', 'role' => 'form', 'id' => 'desembolsarCreditosLote']) !!}
		<div class="container-fluid">
			<div class="card card-warning card-outline">
				<div class="card-header with-border">
					<h3 class="card-title">Desembolsar proceso créditos en lote</h3>
				</div>
				{{-- INICIO card BODY --}}
				<div class="card-body">
					<div class="row">
						<div class="col-md-10 col-md-offset-1">
							<div class="alert alert-warning">
								...
								Se desembolsarán las solicitudes en lote para el presente proceso
							</div>
						</div>
					</div>
					<div class="row">
