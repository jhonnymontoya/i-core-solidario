			...
			<div class="col-md-12">
				<div class="box box-warning">
					<div class="box-header with-border">
						<h3 class="box-title">Limpiar carga proceso ajustes créditos en lote</h3>
					</div>
					{{-- INICIO BOX BODY --}}
					<div class="box-body">
						<div class="row">
					...
					<div class="box-footer">
						...
						<a href="{{ route('ajusteCreditoLoteResumen', $proceso->id) }}" class="btn btn-success pull-right">Volver</a>
					</div>
				</div>
			</div>
		</div>
