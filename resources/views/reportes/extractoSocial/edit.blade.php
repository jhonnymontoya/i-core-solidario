...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        @endif
        {!! Form::model($configuracion, ['url' => ['extractoSocial', $configuracion], 'method' => 'put', 'role' => 'form', 'data-maskMoney-removeMask']) !!}
        <div class="container-fluid">
            <div class="card card-{{ $errors->count()?'danger':'success' }} card-outline">
                <div class="card-header with-border">
                    <h3 class="card-title">Editar configuración de extracto social</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
