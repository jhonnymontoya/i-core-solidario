    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="card card-{{ $errors->count()?'danger':'success' }} card-outline">
                {!! Form::model($oficialCumplimiento, ['url' => 'oficialCumplimiento', 'method' => 'put']) !!}
                <div class="card-header with-border">
                    <h3 class="card-title">Editar oficial de cumplimiento</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                @php
                                    ...
                                    $emailcc = $oficialCumplimiento->email_copia;
                                    $emailcc = empty(old('emailcc')) ? $emailcc : old('emailcc');
                                @endphp
                                <label class="control-label">Copia correo electrónico</label>
                                {!! Form::email('emailcc', $emailcc, ['class' => [$valid, 'form-control'], 'autocomplete' => 'off', 'placeholder' => 'Correo electrónico de copia', 'autofocus']) !!}
