...
<div class="content-wrapper">
	...
	<section class="content">
		...
		@endif
		{!! Form::model($proceso, ['route' => ['ajusteAhorrosLotePutAnular', $proceso], 'method' => 'put', 'role' => 'form']) !!}
		<div class="container-fluid">
			<div class="card card-warning card-outline">
				<div class="card-header with-border">
					<h3 class="card-title">Anular proceso ajuste ahorros en lote</h3>
				</div>
				{{-- INICIO card BODY --}}
				<div class="card-body">
					<div class="row">
				...
				<div class="card-footer">
					...
					<a href="{{ url('ajusteAhorrosLote') }}" class="btn btn-outline-success pull-right">Volver</a>
				</div>
			</div>
		</div>
		{!! Form::close() !!}
