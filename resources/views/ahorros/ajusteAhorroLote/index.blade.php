	...
	<section class="content">
		...
		<div class="container-fluid">
			<div class="card card-{{ $procesos->total()?'primary':'danger' }} card-outline">
				...
				<div class="card-body">
					{!! Form::model(Request::only('name'), ['url' => '/ajusteAhorrosLote', 'method' => 'GET', 'role' => 'search']) !!}
					<div class="row">
										...
										<tr>
											...
											<td>
												...
												@if($proceso->estado == 'PRECARGA' || $proceso->estado == 'CARGADO')
													<a class="btn btn-outline-danger btn-sm" title="Anular" href="{{ route('ajusteAhorrosLoteAnular', $proceso->id) }}"><i class="far fa-times-circle"></i></a>
												@endif
											</td>
										</tr>
									@endforeach
