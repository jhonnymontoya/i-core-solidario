                ...
                <td align="center" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                    <table class="content" width="100%" cellpadding="0" cellspacing="0" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; margin: 0; padding: 0; width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%;">
                                ...
                                <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #FFFFFF; margin: 0 auto; padding: 0; width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
                                    ...
                                    <tr>
                                        <td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                            ...
                                            <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Usted esta recibiendo este correo porque recibimos una petición para restaurar la contraseña de su cuenta.</p>
                                            ...
                                            <table style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; border-top: 1px solid rgb(237, 239, 242); margin-top: 25px; padding-top: 25px" width="100%" cellspacing="0" cellpadding="0"> 
                                                <tbody>
                                                    <tr>
                                                        <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box">
                                                            <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: rgb(116, 120, 126); line-height: 1.5em; margin-top: 0; text-align: left; font-size: 12px">Si tiene problemas haciendo click en el boton "Restaurar contraseña" copie y pegue la siguiente dirección en su navegador web: <a href="{{ $url }}" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: rgb(56, 105, 212)" target="_blank">{{ $url }}</a></p>
                                                            <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: rgb(116, 120, 126); line-height: 1.5em; margin-top: 0; text-align: left; font-size: 12px">Este mensaje ha sido enviado automáticamente, por favor abstenerse de contestarlo.</p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                        ...
                        <tr>
                            ...
                            <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #AEAEAE; font-size: 12px; text-align: center;">© 2017-{{ date('Y') }} Start Line Soft S.A.S. Todos los derechos reservados.</p>
                            </td>
                            </tr>
                            </table>
                            </td>
