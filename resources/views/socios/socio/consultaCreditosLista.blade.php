									...
									<tbody>
										<?php
											...
											foreach($creditos as $credito) {
												...
												<tr>
													<td>
														<a href="{{ route('socioConsultaCreditos', $credito->id) }}?fecha={{ $fechaConsulta }}&socio={{ $socio->id }}">
									...
									<tbody>
										<?php
											foreach($saldados as $saldado) {
												...
												<tr>
													<td>
														<a href="{{ route('socioConsultaCreditos', $saldado->id) }}?fecha={{ $fechaConsulta }}&socio={{ $socio->id }}">
