			...
			<div class="card-body">
				...
				@if($socio)
					...
					<div class="row">
						...
						<div class="col-md-2">
							<div class="widget-user-image">
								<img class="img-circle" src="{{ asset('storage/asociados/' . (empty($socio->avatar)?'avatar-160x160.png':$socio->avatar . "160x160.jpg") ) }}" alt="{{ $socio->nombre_corto }}" />
							</div>
						</div>
					</div>
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation">
							<a href="#" aria-controls="simulador" role="tab" data-toggle="tab">Documentación</a>
						</li>
					</ul>
					...
					<div class="tab-content">
						...
						<div role="tabpanel" class="tab-pane fade" id="ahorros">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="alert alert-info">
										Servicio de deposito a termino SDAT
									</div>
								</div>
							</div>
							<div class="row">
