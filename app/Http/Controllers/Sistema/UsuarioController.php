...
class UsuarioController extends Controller
{
	...
	public function index(Request $request) {
		$entidades = Entidad::with('terceroEntidad')->activa()->get()->pluck('terceroEntidad.razon_social', 'id');
	...
	public function edit(Usuario $obj) {
		...
		$tipos = TipoIdentificacion::activo()
						...
						->get()
						->pluck('nombre', 'id');
		return view('sistema.usuario.edit')->withTipos($tipos)->withUsuario($obj)->withEntidades($entidades);
	}
