...
class EditConfiguracionExtractoSocialRequest extends FormRequest
{
    use ICoreTrait;
    ...
    public function rules()
    {
        ...
        return [
            'anio' => [
                ...
                'integer',
                'between:2010,3000',
                'unique:sqlsrv.reportes.configuraciones_extracto_social,anio,' . $this->obj->id . ',id,entidad_id,' . $entidad->id . ',deleted_at,NULL'
            ],
